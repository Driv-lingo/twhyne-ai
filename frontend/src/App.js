  ...
  return (
    <div className="app">
      ...
      <ConversationManager
        ...
        onAutoSaved={setCurrentConversation}
          ...
          <div className="interaction-panel">
            ...
            <div className="chat-history">
              ...
              {history.length === 0 ? (
                  ...
                  <p className="ephemeral-note">Conversations save automatically on this machine &mdash; never to a cloud &mdash; and survive restarts and browser changes. Reopen them from the &#128172; panel (top left). Documents you want askable belong in a knowledge base.</p>
