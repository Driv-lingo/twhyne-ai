          ...
          <div className="interaction-panel">
            ...
            <div className="chat-history">
              ...
              {history.length === 0 ? (
                  ...
                  <p className="ephemeral-note">Conversations are not saved &mdash; closing or refreshing this window clears the chat. Local-first means nothing is stored unless you put it somewhere: documents you want kept go in a knowledge base.</p>
